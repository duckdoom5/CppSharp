...
namespace CppSharp
{
    ...
    public unsafe class ExprConverter : ExprVisitor<AST.Expr>
    {
        public override AST.Expr VisitConstantExpr(ConstantExpr expr)
        {
            ...
            _expr.Dependence = (AST.ExprDependenceScope.ExprDependence) expr.Dependence;
            ...
            _expr.ResultAPValueKind = (AST.APValue.ValueKind) expr.ResultAPValueKind;
            ...
            _expr.APValueResult = expr.APValueResult;
            _expr.ResultAsAPValue = expr.ResultAsAPValue;
            _expr.ResultAsAPSInt = expr.ResultAsAPSInt;
            return _expr;
        }
        ...
        public override AST.Expr VisitFloatingLiteral(FloatingLiteral expr)
        {
            ...
            _expr.RefersToMatrixElement = expr.RefersToMatrixElement;
            _expr.HasPlaceholderType = expr.HasPlaceholderType;
            _expr.RawSemantics = (AST.llvm.APFloatBase.Semantics) expr.RawSemantics;
        ...
        public override AST.Expr VisitCallExpr(CallExpr expr)
        {
            ...
            for (uint i = 0; i < expr.GetargumentsCount; i++)
            {
                ...
                _expr.Arguments.Add(VisitStatement(_E) as AST.Stmt.CastIterator);
            }
            return _expr;
        }
        ...
        public override AST.Expr VisitGenericSelectionExpr(GenericSelectionExpr expr)
        {
            ...
            _expr.RParenLoc = VisitSourceLocation(expr.RParenLoc);
            for (uint i = 0; i < expr.GetassociationsCount; i++)
            {
                var _E = expr.Getassociations(i);
                _expr.Associations.Add(VisitExpression(_E) as AST.GenericSelectionExpr.AssociationIteratorTy);
            }
            return _expr;
        }
        ...
        public override AST.Expr VisitCXXRewrittenBinaryOperator(CXXRewrittenBinaryOperator expr)
        {
            ...
            _expr.RefersToMatrixElement = expr.RefersToMatrixElement;
            _expr.HasPlaceholderType = expr.HasPlaceholderType;
            _expr.DecomposedForm = expr.DecomposedForm;
        ...
        public override AST.Expr VisitCXXUuidofExpr(CXXUuidofExpr expr)
        {
            ...
            _expr.IsTypeOperand = expr.IsTypeOperand;
            _expr.ExprOperand = VisitExpression(expr.ExprOperand) as AST.Expr;
            _expr.GuidDecl = VisitDeclaration(expr.GuidDecl) as AST.MSGuidDecl;
            _expr.SourceRange = VisitSourceRange(expr.SourceRange);
            return _expr;
        }
        ...
        public override AST.Expr VisitLambdaExpr(LambdaExpr expr)
        {
            ...
            _expr.DependentCallOperator = VisitDeclaration(expr.DependentCallOperator) as AST.FunctionTemplateDecl;
        ...
        public override AST.Expr VisitCXXNewExpr(CXXNewExpr expr)
        {
            ...
            for (uint i = 0; i < expr.GetplacementArgumentsCount; i++)
            {
                ...
                _expr.PlacementArguments.Add(VisitStatement(_E) as AST.Stmt.CastIterator);
            }
            return _expr;
        }
