...
namespace CppSharp
{
    class TemplateArgumentHandler
    {
        ...
        {
            var typeStr = ((TypePrinterResult)type.Type.Visit(printer)).Type;
    ...
    internal static class CodeGeneratorHelpers
    {
        ...
        public static bool IsAbstractExpr(Class @class) =>
            @class.Name is "Expr"
                or "FullExpr"
                or "CastExpr"
                or "ExplicitCastExpr"
        ...
        public static bool SkipProperty(Property property, bool skipBaseCheck = false)
        {
            ...
            var typeName = ((TypePrinterResult)property.Type.Visit(CppTypePrinter)).Type;
        ...
        public static bool SkipMethod(Method method)
        {
            ...
            var typeName = ((TypePrinterResult)method.ReturnType.Visit(CppTypePrinter)).Type;
            ...
            TypePrinter typePrinter)
        {
            ...
            var typeName = ((TypePrinterResult)qualifiedType.Type.Visit(typePrinter)).Type;
            ...
            TypePrinter typePrinter)
        {
            ...
            var typeResult = (TypePrinterResult)declType.Visit(typePrinter);
            ...
            else if (typeName.Contains("optional"))
            {
                ...
                else
                {
                    ...
                    typeResult = (TypePrinterResult)optType.Visit(typePrinter);
                    typeName = $"{typeResult}?";
                }
            }
            ...
            TypePrinter typePrinter)
        {
            ...
            typePrinter.PushScope(TypePrintScopeKind.Qualified);
            var iteratorTypeName = ((TypePrinterResult)iteratorType.Visit(typePrinter)).Type;
            typePrinter.PopScope();
            ...
            else if (iteratorTypeName.Contains("CastIterator"))
            {
                ...
                typePrinter.PushScope(TypePrintScopeKind.Qualified);
                iteratorTypeName = ((TypePrinterResult)iteratorType.Visit(typePrinter)).Type;
                typePrinter.PopScope();
