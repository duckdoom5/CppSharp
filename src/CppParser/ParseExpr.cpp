...
AST::Expr* Parser::WalkExpression(const clang::Expr* Expr)
{
    ...
    case clang::Stmt::ConstantExprClass:
    {
        ...
        _S->dependence = (ExprDependenceScope::ExprDependence) S->getDependence();
        ...
        _S->resultAPValueKind = (APValue::ValueKind) S->getResultAPValueKind();
        _S->resultStorageKind = (ConstantExpr::ResultStorageKind) S->getResultStorageKind();
        _S->isImmediateInvocation = S->isImmediateInvocation();
        _S->hasAPValueResult = S->hasAPValueResult();
        _S->aPValueResult = S->getAPValueResult();
        _S->resultAsAPValue = S->getResultAsAPValue();
        _S->resultAsAPSInt = S->getResultAsAPSInt();
        _Expr = _S;
        break;
    }
    ...
    case clang::Stmt::DeclRefExprClass:
    {
        ...
        _S->isNonOdrUse = (NonOdrUseReason) S->isNonOdrUse();
    ...
    case clang::Stmt::FloatingLiteralClass:
    {
        ...
        _S->refersToMatrixElement = S->refersToMatrixElement();
        _S->hasPlaceholderType = S->hasPlaceholderType();
        _S->rawSemantics = (llvm::APFloatBase::Semantics) S->getRawSemantics();
        _S->exact = S->isExact();
    ...
    case clang::Stmt::CallExprClass:
    {
        ...
        _S->aDLCallKind = (CallExpr::ADLCallKind) S->getADLCallKind();
    ...
    case clang::Stmt::SourceLocExprClass:
    {
        ...
        _S->identKind = (SourceLocExpr::IdentKind) S->getIdentKind();
    ...
    case clang::Stmt::GenericSelectionExprClass:
    {
        ...
        for (auto _E : S->associations())
        {
            auto _ES = WalkExpression(_E);
            _S->addassociations(_ES);
        }
        _Expr = _S;
        break;
    }
    ...
    case clang::Stmt::CXXRewrittenBinaryOperatorClass:
    {
        ...
        _S->refersToMatrixElement = S->refersToMatrixElement();
        _S->hasPlaceholderType = S->hasPlaceholderType();
        _S->decomposedForm = S->getDecomposedForm();
    ...
    case clang::Stmt::CXXUuidofExprClass:
    {
        ...
        _S->isTypeOperand = S->isTypeOperand();
        _S->exprOperand = static_cast<AST::Expr*>(WalkExpression(S->getExprOperand()));
        _S->guidDecl = static_cast<AST::MSGuidDecl*>(WalkDeclaration(S->getGuidDecl()));
        _Expr = _S;
        break;
    }
    ...
    case clang::Stmt::LambdaExprClass:
    {
        ...
        _S->dependentCallOperator = static_cast<AST::FunctionTemplateDecl*>(WalkDeclaration(S->getDependentCallOperator()));
