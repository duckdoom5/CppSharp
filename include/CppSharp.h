...
namespace detail {
    ...
    template <>
    struct StringTypeSelector<E_ANSI>
    {
        typedef std::string Type;
    };
    template <>
    struct StringTypeSelector<E_UTF8>
    {
        typedef std::string Type;
    };
    template <>
    struct StringTypeSelector<E_UTF16>
    {
    ...
    template <>
    struct IfManaged<System::String ^>
    {
        struct Select
        {
            template <typename TrueType, typename FalseType>
    ...
    template <MarshalingDirection direction>
    struct StringMarshaler;
...
template <Encoding encoding, typename SourceType, class ResultType = typename detail::IfManaged<SourceType>::template Select::template Either<typename detail::StringTypeSelector<encoding>::Type, System::String ^>::Type>
